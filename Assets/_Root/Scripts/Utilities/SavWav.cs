...
namespace GlueTrap.Utilities
{
	public static class SavWav
	{
		...
		private static void WriteHeader(FileStream fileStream, AudioClip clip)
		{
			...
			fileStream.Write(BitConverter.GetBytes(fileStream.Length - 8), 0,
				4);
			...
			fileStream.Write(BitConverter.GetBytes((ushort)(channels * 2)), 0,
				2);
			fileStream.Write(BitConverter.GetBytes((ushort)16), 0, 2);
			fileStream.Write(Encoding.UTF8.GetBytes("data"), 0, 4);
			fileStream.Write(BitConverter.GetBytes(samples * channels * 2), 0,
				4);
		}
	}
}