...
public class ChangeTextSpeed : MonoBehaviour
{
	...
	private UnityUITypewriterEffect
		typewriterEffect; // The custom typewriter script
		...
		buttonText =
			gameObject
				.GetComponentInChildren<
					Text>(); // Get this gameobject's text child
		typewriterEffect =
			subtitleText
				.GetComponentInChildren<
					UnityUITypewriterEffect>(); // Get the typewriter component of the subtitle text.
	...
	public void IncreaseTextSpeed()
	{
		...
		typewriterEffect.charactersPerSecond =
			typeSpeed * currentMultiplier; // Apply new speed
	}
